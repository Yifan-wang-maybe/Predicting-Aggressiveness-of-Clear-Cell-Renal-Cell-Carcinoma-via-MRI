...
### Modified based on https://github.com/qubvel/segmentation_models.pytorch/blob/master/segmentation_models_pytorch/losses/dice.py
class DiceLoss(_Loss):
    ...
    def forward(self, y_pred: torch.Tensor, y_true: torch.Tensor) -> torch.Tensor:
        ...
        loss = self.aggregate_loss(loss)
        loss = loss*len(mask)/max(sum(mask),1)
